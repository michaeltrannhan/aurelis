...
public struct WidgetSnapshot: Codable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            statusMessage: container.widgetTolerant(String.self, forKey: .statusMessage) ?? "Open EQMacRep to use widget controls.",
    ...
    public static let empty = WidgetSnapshot(
        ...
        statusMessage: "Open EQMacRep to use widget controls.",
        activeAppCount: 0,
        volumeStep: 0.05,
        devices: [],
        apps: []
