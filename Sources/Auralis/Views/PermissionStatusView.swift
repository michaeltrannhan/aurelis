...
struct PermissionPresentation {
    ...
    init(state: AudioCapturePermissionState) {
        ...
        if state.audioUsageDescription == .missing {
            ...
            detail = "This build is missing its audio-capture usage description. System Settings cannot repair it; launch Auralis from the packaged .app bundle."
        ...
        case .granted:
            ...
            detail = "Auralis can process other apps’ audio in real time."
        ...
        case .pendingRestart:
            ...
            detail = "macOS applies Screen & System Audio Recording after a restart. Reopen Auralis to activate real-time control."
        ...
        case .denied:
            ...
            detail = "Turn on Auralis under Screen & System Audio Recording in System Settings, then reopen the app."
