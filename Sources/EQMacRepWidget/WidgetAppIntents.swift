...
private enum WidgetIntentError: LocalizedError {
    ...
    var errorDescription: String? {
        "Open EQMacRep before using widget controls."
    }
}
...
struct RefreshAppIntent: AppIntent {
    ...
    static let description = IntentDescription("Tell EQMacRep to rescan audio apps and devices.")
...
struct EQMacRepAppShortcuts: AppShortcutsProvider {
